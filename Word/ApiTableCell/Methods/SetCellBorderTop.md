...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| sType | Required | BorderType |  | The cell top border style. |
| nSize | Required | pt_8 |  | The width of the current cell top border measured in eighths of a point. |
| nSpace | Required | pt |  | The spacing offset in the top part of the table cell measured in points used to place this border. |
