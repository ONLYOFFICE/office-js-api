...
| nIndLeft | Optional | EMU | ApiPresentation.GetWidth() / 2 | The Text Art left side indentation value measured in English measure units. |
| nIndTop | Optional | EMU | ApiPresentation.GetHeight() / 2 | The Text Art top side indentation value measured in English measure units. |
