...
| bIsBold | Required | bool |  | Specifies if the horizontal axis title is written in bold font or not.* @see office-js-api/Examples/{Editor}/ApiChart/Methods/SetHorAxisTitle.js |
