...
| [SetScaleFlag](./Methods/SetScaleFlag.md) | [boolean](../../Word/boolean/boolean.md) | Sets the scaling condition to the current picture form. |
| [SetLockAspectRatio](./Methods/SetLockAspectRatio.md) | [boolean](../../Word/boolean/boolean.md) | Locks the aspect ratio of the current picture form. |
| [IsLockAspectRatio](./Methods/IsLockAspectRatio.md) | [boolean](../../Word/boolean/boolean.md) | Checks if the aspect ratio of the current picture form is locked or not. |
| [SetPicturePosition](./Methods/SetPicturePosition.md) | [boolean](../../Word/boolean/boolean.md) | Sets the picture position inside the current form: **0** - the picture is placed on the left/top; **50** - the picture is placed in the center; **100** - the picture is placed on the right/bottom. |
...
| [SetRespectBorders](./Methods/SetRespectBorders.md) | [boolean](../../Word/boolean/boolean.md) | Respects the form border width when scaling the image. |
| [IsRespectBorders](./Methods/IsRespectBorders.md) | [boolean](../../Word/boolean/boolean.md) | Checks if the form border width is respected or not. |
...
| [SetImage](./Methods/SetImage.md) | [boolean](../../Word/boolean/boolean.md) | Sets an image to the current picture form. |
