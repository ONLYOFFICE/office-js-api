...
| ---- | ---- | ----------- |
| Name | [string](../../Word/string/string.md) | Style name (for example, "Heading 1"). |
| Lvl | [number](../../Word/number/number.md) | Level which will be applied to the specified style in the table of contents. |
