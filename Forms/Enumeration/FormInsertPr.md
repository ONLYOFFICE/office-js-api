...
| ---- | ---- | ----------- |
| placeholderFromSelection | [boolean](../../Word/boolean/boolean.md) | Specifies if the currently selected text should be saved as a placeholder of the inserted form. |
| keepSelectedTextInForm | [boolean](../../Word/boolean/boolean.md) | Specifies if the currently selected text should be saved as the content of the inserted form. |
