...
| lockAspectRatio | [boolean](../../Word/boolean/boolean.md) | Specifies if the aspect ratio of the picture form is locked or not. |
| respectBorders | [boolean](../../Word/boolean/boolean.md) | Specifies if the form border width is respected or not when scaling the image. |
