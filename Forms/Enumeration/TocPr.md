...
| ---- | ---- | ----------- |
| ShowPageNums | [boolean](../../Word/boolean/boolean.md) | Specifies whether to show page numbers in the table of contents. |
| RightAlgn | [boolean](../../Word/boolean/boolean.md) | Specifies whether to right-align page numbers in the table of contents. |
| LeaderType | [TocLeader](../Enumeration/TocLeader.md) | The leader type in the table of contents. |
| FormatAsLinks | [boolean](../../Word/boolean/boolean.md) | Specifies whether to format the table of contents as links. |
