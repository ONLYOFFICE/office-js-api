...
| ------ | ------- | ----------- |
| [SetChecked](./Methods/SetChecked.md) | [boolean](../../Word/boolean/boolean.md) | Checks the current checkbox. |
| [IsChecked](./Methods/IsChecked.md) | [boolean](../../Word/boolean/boolean.md) | Returns the state of the current checkbox (checked or not). |
| [IsRadioButton](./Methods/IsRadioButton.md) | [boolean](../../Word/boolean/boolean.md) | Checks if the current checkbox is a radio button. |
| [GetRadioGroup](./Methods/GetRadioGroup.md) | [string](../../Word/string/string.md) | Returns the radio group key if the current checkbox is a radio button. |
| [SetRadioGroup](./Methods/SetRadioGroup.md) | [boolean](../../Word/boolean/boolean.md) | Sets the radio group key to the current radio button. |
