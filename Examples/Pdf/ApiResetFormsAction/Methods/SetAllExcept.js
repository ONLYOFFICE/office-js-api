// This example creates a reset forms action and changes its all-except mode.
...
resetAction.SetAllExcept(true);
console.log('Is all except after change: ' + resetAction.IsAllExcept());
