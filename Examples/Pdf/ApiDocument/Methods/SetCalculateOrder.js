// This example sets the calculation order of fields in the document.
...
let result = doc.SetCalculateOrder(["Total", "Tax"]);
console.log('Calculate order set: ' + result);
console.log('Current order: ' + doc.GetCalculateOrder());
