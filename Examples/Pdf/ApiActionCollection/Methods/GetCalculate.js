// This example gets the Calculate action from a text field's action collection.
...
actions.SetCalculate(calcAction);

let action = actions.GetCalculate();
console.log('Calculate action script: ' + action.GetScript());
