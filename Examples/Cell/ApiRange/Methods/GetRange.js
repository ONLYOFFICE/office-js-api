...
parentRange.SetBorders("xlEdgeTop", "xlThick", Api.RGB(255, 111, 61));

let subRange1 = parentRange.GetRange("A1:B2");
subRange1.SetValue("Sub 1");
subRange1.SetFillColor(Api.RGB(255, 213, 191));

let subRange2 = parentRange.GetRange("C3:D4");
subRange2.SetValue("Sub 2");
subRange2.SetFillColor(Api.RGB(173, 216, 230));
...
subRange3.SetFillColor(Api.RGB(255, 255, 0));